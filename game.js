  ...
  switch (condition.type) {
      ...
      case "specialEffect":
          ...
          if (condition.comparison === "notSet") {
           ...
           return false;
       case "allSpecialEffects":
           if (Array.isArray(condition.flags)) {
               return condition.flags.every(flag => gameState.specialEffects.includes(flag));
           }
           console.warn("Invalid flags for allSpecialEffects:", condition.flags);
           return false;
       default:
